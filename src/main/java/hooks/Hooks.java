...
public class Hooks {
    ...
    @BeforeMethod
    public void beforemMethod(Method method ){
        ExtentTest extentTest = extent.createTest(method.getName().toLowerCase(Locale.ROOT));
        test.set(extentTest);
    }
    ...
    public void afterMethod(ITestResult result){
        if(result.getStatus() == ITestResult.FAILURE){
            ...
            test.get().pass("Test Passed sucessfully!!");
        }
        extent.flush();
    }
